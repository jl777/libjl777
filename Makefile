...
CC=clang  
CFLAGS=-Wall -O2 -std=c99 -Wextra -pedantic -g -fPIC -Iplugins/includes  -Iplugins/includes/nanomsg -Iplugins/includes/libtom  -Iplugins/includes/miniupnp  -Iplugins/utils -Iincludes -I../includes -I../../includes -I/usr/include -Wunused-parameter -Wno-unused-function -fPIC -fvisibility=hidden -fstack-protector-all -Wstack-protector -D_FORTIFY_SOURCE=2
