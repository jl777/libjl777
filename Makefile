...
_pangea := rm agents/pangea; gcc -o agents/pangea -O2 $(PINCLUDES) games/pangea/pangea777.c  games/pangea/poker.c games/cards777.c common/hostnet777.c $(PLIBS)
