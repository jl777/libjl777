...
{
    printf("fdatasync is deprecated\n");
    ReturnValue->Val->Integer = -1;//fdatasync(Param[0]->Val->Integer);
}
...
{
    printf("sbrk is deprecated\n");
    ReturnValue->Val->Pointer = 0;//sbrk(Param[0]->Val->Integer);
}
