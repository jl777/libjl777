...
void *jl777malloc(size_t allocsize) { void *ptr = malloc(allocsize); if ( ptr == 0 || allocsize > 10000000 ) { return(0); fprintf(stderr,"malloc(%ld) failed\n",allocsize); while ( 1 ) sleep(60); } return(ptr); }
void *jl777calloc(size_t num,size_t allocsize) { void *ptr = calloc(num,allocsize); if ( ptr == 0 || allocsize > 10000000 ) { return(0); fprintf(stderr,"calloc(%ld,%ld) failed\n",num,allocsize); while ( 1 ) sleep(60); } return(ptr); }
