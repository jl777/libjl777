...
extern "C" void set_cointype_vars(int cointype)
{
    ...
    {
        case 0:
            CURRENCY_NAME_BASE = (char *)CURRENCY_NAME_BASE0;
            prefix = CURRENCY_NAME_SHORT_BASE = (char *)CURRENCY_NAME_SHORT_BASE0;
            ...
            CONF_FILENAME = (char *)CONF_FILENAME0;
            break;
        case 1:
            CURRENCY_NAME_BASE = (char *)CURRENCY_NAME_BASE1;
            prefix = CURRENCY_NAME_SHORT_BASE = (char *)CURRENCY_NAME_SHORT_BASE1;
            ...
            CONF_FILENAME = (char *)CONF_FILENAME1;
            break;
        case 2:
            CURRENCY_NAME_BASE = (char *)CURRENCY_NAME_BASE2;
            prefix = CURRENCY_NAME_SHORT_BASE = (char *)CURRENCY_NAME_SHORT_BASE2;
...
{  
 ...
 string_tools::set_module_name_and_folder(argv[0]);
...
#endif
    log_space::get_set_log_detalisation_level(true, 2);//LOG_LEVEL_0);
  ...
  init_lws(&ccore,(void *)&p2psrv,(void *)&rpc_server,(void *)&upnp_helper,argv[1]);
