...
namespace nodetool
{
  ...
  {
#ifndef TESTNET
    ADD_HARDCODED_SEED_NODE("209.126.73.156:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
    ADD_HARDCODED_SEED_NODE("209.126.73.158:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
#else
    ADD_HARDCODED_SEED_NODE("209.126.71.170:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
#endif
