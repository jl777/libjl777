...
namespace nodetool
{
  ...
  {
#ifndef TESTNET
    ADD_HARDCODED_SEED_NODE("209.126.70.156:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
    ADD_HARDCODED_SEED_NODE("209.126.70.159:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
#else
    ADD_HARDCODED_SEED_NODE("209.126.70.170:" STRINGIFY_EXPAND(P2P_DEFAULT_PORT));
#endif
